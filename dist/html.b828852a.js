...
function signIn(event) {
    ...
    fetch("/api/signin", {
        ...
        if (!response.ok) throw new Error("Anv\xe4ndarnamnet eller l\xf6senordet \xe4r fel") //passar det här?
        ;
...
async function fetchUser() {
    ...
    try {
        ...
        //validering
        if (!response.ok) throw new Error("Kunde inte h\xe4mta anv\xe4ndardata");
